<template>
      <div class="mt-auto mb-auto">
           <button @click="toggleModal" class="p-2 flex bg-gray-dark rounded-full border-4 border-white-light justify-self-end"> 
        ...
        <Modal class="border-4 flexbox max-w-sm mx-auto my-auto" @toggle="toggleModal"><slot>
            ...
            <button class="text-white-light border-2 w-10 bg-gray-dark"><font-awesome-icon :icon="['fas', 'caret-left']" style="filter:invert(0%)" /></button>
             </form>
             </slot> </Modal>
            </div>
